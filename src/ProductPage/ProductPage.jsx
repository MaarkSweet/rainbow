...
export default function ProductPage() {
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            try {
                const response = await fetch(`http://https://rainbow-backend-a9w1.onrender.com//api/catalog/${id}`);
    ...
    const addToCart = async () => {
        ...
        try {
            await fetch('http://https://rainbow-backend-a9w1.onrender.com//api/cart/add', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },

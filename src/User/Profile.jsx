...
export default function Profile() {
    ...
    const handleCheckOldPassword = async () => {
        const response = await fetch('http://https://rainbow-backend-a9w1.onrender.com//api/change-password', {
            method: 'POST',
    ...
    useEffect(() => {
        if (user?.id) {
            fetch(`http://https://rainbow-backend-a9w1.onrender.com//api/favorites/${user.id}`)
                .then(res => res.json())
    ...
    const handleUpdateAddress = async () => {
        const response = await fetch('http://https://rainbow-backend-a9w1.onrender.com//api/update-address', {
            method: 'PUT',
            headers: { 'Content-Type': 'application/json' },
    ...
    const removeFromFavorites = async (productName) => {
        try {
            const response = await fetch('http://https://rainbow-backend-a9w1.onrender.com//api/favorites/remove', {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
                },
